...
void main(){
	...
	window = CreateWindowEx(0,name,name,0x10080000,0,0,res + 16,res + 32,0,0,wndclass.hInstance,0);
	dc = GetDC(window);

	for(;;){
		openCL();
		StretchDIBits(dc,0,0,res,res,0,0,res,res,data,&bmi,0,SRCCOPY);
